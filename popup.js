...
const SETTINGS_KEYS = ['hidePopups', 'includeBackground', 'lightMode'];
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    ['hidePopups', 'includeBackground'].forEach(key => {
  ...
  // Persist each option toggle as it changes
  ['hidePopups', 'includeBackground'].forEach(key => {
  ...
  document.getElementById('themeBtn').addEventListener('click', () => {
    ...
    chrome.storage.sync.set({ lightMode: isLight });
  });
